...
export default function PatientDashboard() {
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="flex">
        {/* Sidebar */}
        <aside className="w-1/4 bg-white p-4 shadow h-screen">
          <nav>
            <ul className="space-y-3">
              ...
              <li><button onClick={() => setActiveTab('wallet')} className="text-gray-800 hover:text-blue-600">💳 Wallet</button></li>
              <li><button onClick={() => setActiveTab('appointments')} className="text-gray-800 hover:text-blue-600">📅 Appointments</button></li>
              <li><button onClick={() => setActiveTab('documents')} className="text-gray-800 hover:text-blue-600">📄 Documents</button></li>
              <li><button onClick={() => setActiveTab('messages')} className="text-gray-800 hover:text-blue-600">📬 Messages</button></li>
              <li><button onClick={() => setActiveTab('transactions')} className="text-gray-800 hover:text-blue-600">💰 Transactions</button></li>
              <li><button onClick={() => setActiveTab('uploads')} className="text-gray-800 hover:text-blue-600">📷 Uploads</button></li>
            </ul>
          </nav>
        </aside>
