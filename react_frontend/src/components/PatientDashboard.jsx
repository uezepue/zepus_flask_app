  ...
  return (
    <div className="dashboard">
      ...
      <aside className="sidebar">
        <nav>
          <ul>
            <li><Link to="/chatroom">Chat with Dr Zepus</Link></li>
      ...
      <div className="floating-buttons">
        <Link to="/chatroom" className="btn-primary pulse-button">Talk to Dr Zepus</Link>
        <a href="#wallet" className="btn-secondary">Wallet</a>
      </div>
    </div>
  );
}
